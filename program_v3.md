...
- **v1** (program.md): file-chain + mechanical keyword rule + cross-agent
  verification. Caught the prior "skip web_search" failure and the
  "motivated narrowing" failure. **R001-R025** ran under v1.
- **v2** (program_v2.md): Form A/B/C/D rotation + query/composition
  rules. Reduced mean forced-hit count and disagreement rate but
  exposed mechanical-PASS artifacts on narrow content_words.
  **R026-R050** ran under v2.
- **v3** (this file): adds step 04.5 memory check. Targets the
  ...
  artifact is produced. **R051-R075** ran under v3.
