...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function us(e,t,n){let r=new Float32Array(Xo),i=new W(0,1,0);return new ja({name:`SphericalGaussianBlur`,defines:{n:Xo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ps(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ds(){return new ja({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:ps(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function fs(){return new ja({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ps(),fragmentShader:`
	...
	`}var ms=class extends Dt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Zr(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`};function Xd(t,n,r){let i=document.createElement(`canvas`);i.width=t,i.height=t,n(i.getContext(`2d`),Tu.fromString(`texture`,r));let a=new Qr(i);return a.wrapS=e,a.wrapT=e,a.colorSpace=Ie,a.anisotropy=4,a}function Zd(e,t,n,r,i,a,o){for(let s=0;s<r;s++){e.fillStyle=t.float()<.5?a:o,e.globalAlpha=i*t.float();let r=1+t.float()*2.5;e.fillRect(t.float()*n,t.float()*n,r,r)}e.globalAlpha=1}function Qd(){return Xd(256,(e,t)=>{e.fillStyle=`#4a3526`,e.fillRect(0,0,256,256);for(let n=0;n<90;n++){let n=t.float()*256,r=.6+t.float()*2.2,i=.75+t.float()*.5;e.strokeStyle=`rgba(${Math.floor(58*i)}, ${Math.floor(40*i)}, ${Math.floor(26*i)}, 0.55)`,e.lineWidth=r,e.beginPath();let a=n;e.moveTo(a,-4);for(let n=0;n<=260;n+=16)a+=(t.float()-.5)*5,e.lineTo(a,n);e.stroke()}Zd(e,t,256,1600,.1,`#7a5a3e`,`#241710`)},`wood`)}function $d(){return Xd(256,(e,t)=>{e.fillStyle=`#6d6157`,e.fillRect(0,0,256,256);for(let n=0;n<220;n++){let n=6+t.float()*30,r=e.createRadialGradient(0,0,0,0,0,n),i=t.float()<.5?`109, 100, 92`:`92, 82, 73`;r.addColorStop(0,`rgba(${i}, ${.12*t.float()})`),r.addColorStop(1,`rgba(0,0,0,0)`),e.save(),e.translate(t.float()*256,t.float()*256),e.fillStyle=r,e.fillRect(-n,-n,n*2,n*2),e.restore()}Zd(e,t,256,2400,.08,`#8a7d70`,`#43392f`)},`stone`)}function ef(){return Xd(256,(e,t)=>{e.fillStyle=`#5b5148`,e.fillRect(0,0,256,256),Zd(e,t,256,2600,.1,`#776a5d`,`#372e26`),e.strokeStyle=`rgba(30, 24, 19, 0.5)`,e.lineWidth=2;for(let n=0;n<=2;n++)e.beginPath(),e.moveTo(0,n*128+t.float()*8),e.lineTo(256,n*128+t.float()*8),e.stroke(),e.beginPath(),e.moveTo(n*128+t.float()*8,0),e.lineTo(n*128+t.float()*8,256),e.stroke()},`floor`)}function tf(){return Xd(128,(e,t)=>{e.fillStyle=`#b8b0a6`,e.fillRect(0,0,128,128),Zd(e,t,128,1500,.16,`#d8d0c4`,`#6a6258`),e.fillStyle=`rgba(220, 205, 160, 0.5)`;for(let t of[22,38,92,108])e.fillRect(0,t,128,2)},`leather`)}function nf(){return{wood:new Na({map:Qd(),roughness:.82,metalness:0}),stone:new Na({map:$d(),roughness:.95,metalness:0}),floor:new Na({map:ef(),roughness:.9,metalness:0}),book:new Na({map:tf(),roughness:.75,metalness:0}),brass:new Na({color:10124104,roughness:.38,metalness:.85}),lamp:new Na({color:2299143,emissive:16761450,emissiveIntensity:2.6,roughness:.4}),darkGlass:new Na({color:1053722,roughness:.05,metalness:.9}),glow:new vr({color:16767120,transparent:!0,opacity:0,depthWrite:!1,side:2})}}var rf=[7224108,6113843,5193552,3753807,5784887,7033141,4864558,5386539,4147770,6049089,6701103,4669525].map(e=>new J(e));function af(e,t=!1){let n=e[0].index!==null,r=new Set(Object.keys(e[0].attributes)),i=new Set(Object.keys(e[0].morphAttributes)),a={},o={},s=e[0].morphTargetsRelative,c=new sr,l=0;for(let u=0;u<e.length;++u){let d=e[u],f=0;if(n!==(d.index!==null))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. All geometries must have compatible attributes; make sure index attribute exists among all geometries, or in none of them.`),null;for(let e in d.attributes){if(!r.has(e))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. All geometries must have compatible attributes; make sure "`+e+`" attribute exists among all geometries, or in none of them.`),null;a[e]===void 0&&(a[e]=[]),a[e].push(d.attributes[e]),f++}if(f!==r.size)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. Make sure all geometries have the same number of attributes.`),null;if(s!==d.morphTargetsRelative)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. .morphTargetsRelative must be consistent throughout all geometries.`),null;for(let e in d.morphAttributes){if(!i.has(e))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`.  .morphAttributes must be consistent throughout all geometries.`),null;o[e]===void 0&&(o[e]=[]),o[e].push(d.morphAttributes[e])}if(t){let e;if(n)e=d.index.count;else if(d.attributes.position!==void 0)e=d.attributes.position.count;else return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. The geometry must have either an index or a position attribute`),null;c.addGroup(l,e,u),l+=e}}if(n){let t=0,n=[];for(let r=0;r<e.length;++r){let i=e[r].index;for(let e=0;e<i.count;++e)n.push(i.getX(e)+t);t+=e[r].attributes.position.count}c.setIndex(n)}for(let e in a){let t=of(a[e]);if(!t)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the `+e+` attribute.`),null;c.setAttribute(e,t)}for(let e in o){let t=o[e][0].length;if(t!==0){c.morphAttributes=c.morphAttributes||{},c.morphAttributes[e]=[];for(let n=0;n<t;++n){let t=[];for(let r=0;r<o[e].length;++r)t.push(o[e][r][n]);let r=of(t);if(!r)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the `+e+` morphAttribute.`),null;c.morphAttributes[e].push(r)}}}return c}function of(e){let t,n,r,i=-1,a=0;for(let o=0;o<e.length;++o){let s=e[o];if(t===void 0&&(t=s.array.constructor),t!==s.array.constructor)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.array must be of consistent array types across matching attributes.`),null;if(n===void 0&&(n=s.itemSize),n!==s.itemSize)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.itemSize must be consistent across matching attributes.`),null;if(r===void 0&&(r=s.normalized),r!==s.normalized)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.normalized must be consistent across matching attributes.`),null;if(i===-1&&(i=s.gpuType),i!==s.gpuType)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.gpuType must be consistent across matching attributes.`),null;a+=s.count*n}let o=new t(a),s=new Kn(o,n,r),c=0;for(let t=0;t<e.length;++t){let r=e[t];if(r.isInterleavedBufferAttribute){let e=c/n;for(let t=0,i=r.count;t<i;t++)for(let i=0;i<n;i++){let n=r.getComponent(t,i);s.setComponent(t+e,i,n)}}else o.set(r.array,c);c+=r.count*n}return i!==void 0&&(s.gpuType=i),s}var sf=ed;function cf(e,t,n,r,i,a,o,s=0,c=.55){let l=new ni(i,a,o),u=l.attributes.uv;for(let e=0;e<u.count;e++)u.setXY(e,u.getX(e)*Math.max(i,o)*c,u.getY(e)*Math.max(a,.4)*c);s!==0&&l.rotateY(s),l.translate(t,n,r),e.push(l)}function lf(e,t,n,r,i,a,o,s){e.push({ax:t,az:n,bx:r,bz:i,y0:a,y1:o,pad:s})}function uf(e){let t=new ri(cd,cd,e,6,1,!0);return t.rotateY(Math.PI/6),t}function df(e){return new ri(wd,wd,e,24,1,!0)}function ff(e,t,n){let r=new Pi,i=Td,a=wd-.015;r.moveTo(i*Math.cos(e),i*Math.sin(e));for(let n=0;n<=5;n++){let i=e+(t-e)*n/5;r.lineTo(a*Math.cos(i),a*Math.sin(i))}for(let n=5;n>=0;n--){let a=e+(t-e)*n/5;r.lineTo(i*Math.cos(a),i*Math.sin(a))}let o=new va(r,{depth:n,bevelEnabled:!1});return o.rotateX(Math.PI/2),o}function pf(e){let t=sd/2,n=2.6,r=new Pi;r.moveTo(-t,-2.6),r.lineTo(t,-2.6),r.lineTo(t,n),r.lineTo(-t,n),r.closePath();let i=new Ni,a=Ud(cd);i.moveTo(a[0][0],a[0][1]);for(let e=1;e<6;e++)i.lineTo(a[e][0],a[e][1]);i.closePath(),r.holes.push(i);let o=new Ni;o.absarc(e.x,e.z,wd+.02,0,Math.PI*2,!0),r.holes.push(o);let s=new va(r,{depth:nd,bevelEnabled:!1});return s.rotateX(Math.PI/2),s}function mf(){let e=[],t=[],n=[],r=[],i=[],a=Array(640),o=[,,,,],s=Ud($u),c={x:sf+kd,z:Od},l={x:sf+kd-sd,z:Od};{let e=pf(l);e.translate(0,0,0),t.push(e)}for(let t=0;t<4;t++){let{v0:n,v1:r}=Gd[t],c=s[n],l=s[r],u=(c[0]+l[0])/2,d=(c[1]+l[1])/2,f=Math.hypot(u,d),p=u/f,m=d/f,h=Math.atan2(p,m);o[t]=h;let g=-m,_=p,v=(e,t,n,r,i,a,o)=>{cf(o,p*n+g*e,t,m*n+_*e,r,i,a,h)};v(0,td/2,sf-.025,$u-.02,td,.05,e);let y=(vd+.12)/2+.06;v(-y,td/2,sf-dd/2,.12,td,dd,e),v(y,td/2,sf-dd/2,.12,td,dd,e);for(let t=0;t<=5;t++)v(0,t*pd+fd/2,sf-dd/2-.005,vd+.12,fd,dd-.04,e);let b=(sf-dd)/sf;lf(i,c[0]*b,c[1]*b,l[0]*b,l[1]*b,0,td,.015);for(let e=0;e<5;e++){let n=(4-e)*pd+fd+md/2;for(let r=0;r<32;r++){let i=-vd/2+_d*(r+.5),o=sf-dd+yd+hd/2,s=new q;s.makeRotationY(h),s.setPosition(p*o+g*i,n,m*o+_*i),a[(t*5+e)*32+r]=s}}}for(let n of[1,-1]){let r=n*(sf+Vd/2),a=$u/2,o=ad/2;for(let e of[-1,1]){let n=e*o,s=e*a;cf(t,r,td/2,(n+s)/2,Vd,td,Math.abs(s-n)),lf(i,r,n,r,s,0,td,Vd/2)}cf(t,r,(od+td)/2,0,Vd,td-od,ad);for(let t of[-1,1])cf(e,r,od/2,t*(o+.02),Vd+.04,od,.05)}let u=sf+Vd,d=sf+3-Vd,f=-id/2,p=id/2,m=f-Vd/2,h=p+Vd/2,g=sf+.24,_=g+Sd,v=c.x-Ad,y=c.x+Ad,b=(e,n,r,a)=>{let o=n,s=[],c=a.slice().sort((e,t)=>e[0]-t[0]);for(let[n,r,i]of c)n>o&&s.push([o,n]),cf(t,(n+r)/2,(i+td)/2,e,r-n,td-i,Vd),o=r;o<r&&s.push([o,r]);for(let[n,r]of s)cf(t,(n+r)/2,td/2,e,r-n,td,Vd),lf(i,n,e,r,e,0,td,Vd/2)};b(m,u,d,[[g,_,Cd],[v,y,od]]),b(h,u,d,[[g,_,Cd]]);for(let n of[-1,1]){let r=n*(id/2+Vd),a=n*(id/2+Vd+xd),o=sf+.16,s=o+bd;cf(t,(o+s)/2,td/2,a+n*Vd/2,bd+2*Vd,td,Vd),lf(i,o,a,s,a,0,td,Vd/2);for(let e of[o,s])cf(t,e+Vd/2*(e===o?-1:1),td/2,(r+a)/2,Vd,td,Math.abs(a-r)),lf(i,e,r,e,a,0,td,Vd/2);n>0?(cf(t,(o+s)/2,.19,a-n*.26,.42,.38,.4),lf(i,o+.1,a-n*.46,s-.1,a-n*.46,0,.38,.02)):cf(e,(o+s)/2,1.05,a-n*.05,bd-.1,1.9,.05)}let x={x:c.x,y:(Md+Nd)/2,z:p-.015};{let t=Nd-Md;cf(e,x.x,x.y,p+.01,jd+.1,t+.1,.04)}{let n=Math.PI/2;for(let t=1;t<16;t++){let r=n-t*Dd+Dd/2,i=ff(r-Dd,r,.07);i.translate(c.x,t*Ed,c.z),e.push(i)}{let t=ff(n-Dd,n+Dd,.07);t.translate(c.x,0,c.z),e.push(t)}cf(t,c.x,-.036,-id/2-.005,2*Ad+.04,.068,.24);let r=new ri(Td,Td,rd,12);r.translate(c.x,rd/2,c.z),t.push(r);let i=Math.asin(Ad/wd),a=new ri(wd+.02,wd+.02,rd,24,1,!0,n+i-Math.PI/2,Math.PI*2-2*i);a.translate(c.x,rd/2,c.z),t.push(a);let o=new ri(wd+.02,wd+.02,rd-od,8,1,!0,n-i-Math.PI/2,2*i);o.translate(c.x,od+(rd-od)/2,c.z),t.push(o)}{let e=Ud(ld);for(let t=0;t<6;t++){let r=e[t],a=e[(t+1)%6];cf(n,r[0],ud/2,r[1],.045,ud,.045);let o=(r[0]+a[0])/2,s=(r[1]+a[1])/2,c=Math.hypot(a[0]-r[0],a[1]-r[1]),l=Math.atan2(a[0]-r[0],a[1]-r[1]);cf(n,o,ud-.02,s,.05,.04,c,l),cf(n,o,ud*.5,s,.03,.025,c,l),lf(i,r[0],r[1],a[0],a[1],0,ud,.03)}}let S=[{x:0,y:td-.07,z:-1.1},{x:0,y:td-.07,z:1.1}];for(let e of S){let t=new Sa(Pd,18,12);t.translate(e.x,e.y,e.z),r.push(t);let i=new ri(Pd+.025,Pd+.04,.05,12);i.translate(e.x,td-.02,e.z),n.push(i)}let C=e=>af(e.map(e=>e.index?e.toNonIndexed():e));return{wood:C(e),stone:C(t),brass:C(n),lamps:C(r),bookMatrices:a,wallYaws:o,segments:i,stairAxis:c,slabStairAxis:l,mirrorCenter:x,lampCenters:S}}var hf={rx:4,ry:3,bookFloors:3,liveMirrors:!0,dpr:2,antialias:!0},gf={rx:2,ry:1,bookFloors:0,liveMirrors:!1,dpr:1,antialias:!1},_f=70,vf=class{scene=new pn;template;palette;quality;c0;f0=0;books;shells=[];glass;tubes;stairTubes;lights=[];reflectors=[];highlightMesh=null;dxs=[];dys=[];constructor(e,t){this.c0=du(e.c),this.f0=e.f,this.quality=t,this.template=mf(),this.palette=nf(),this.scene.background=new J(525828),this.scene.fog=new fn(525828,t.rx>=4?.11:.16);for(let e=-t.rx-1;e<=t.rx;e++)this.dxs.push(e);for(let e=-t.ry;e<=t.ry+1;e++)this.dys.push(e);this.buildInstances(),this.buildLights(),this.buildMirrors(),this.retile()}unitCount(){return this.dxs.length*this.dys.length}buildInstances(){let e=this.template,t=this.palette,n=this.unitCount();for(let e of[t.wood,t.stone,t.floor,t.brass,t.book])e.side=2;let r=(e,t)=>{let r=new Hr(e,t,n);return r.frustumCulled=!1,this.scene.add(r),this.shells.push(r),r};r(e.wood,t.wood),r(e.stone,t.stone),r(e.brass,t.brass),r(e.lamps,t.lamp);let i=new ni(gd-.006,md,hd);this.books=new Hr(i,t.book,n*640),this.books.frustumCulled=!1,this.scene.add(this.books);let a=new xa(jd,Nd-Md);a.rotateY(Math.PI),this.glass=new Hr(a,t.darkGlass,n),this.glass.frustumCulled=!1,this.scene.add(this.glass);let o=new vr({color:328707,side:1,fog:!0});this.tubes=new Hr(uf(_f),o,this.dxs.length*2),this.tubes.frustumCulled=!1,this.scene.add(this.tubes),this.stairTubes=new Hr(df(_f),o,this.dxs.length*2),this.stairTubes.frustumCulled=!1,this.scene.add(this.stairTubes),this.scene.add(new po(5655100,.35))}buildLights(){for(let e=0;e<6;e++){let e=new uo(16760938,7.5,0,2);this.lights.push(e),this.scene.add(e)}for(let e=0;e<3;e++){let e=new uo(16767392,1.6,0,2);this.lights.push(e),this.scene.add(e)}for(let e=0;e<2;e++){let e=new uo(16760938,3,0,2);this.lights.push(e),this.scene.add(e)}}buildMirrors(){if(!this.quality.liveMirrors)return;let e=this.template;for(let t of[0,-1]){let n=new Yd(new xa(jd,Nd-Md),{clipBias:.003,textureWidth:512,textureHeight:512,color:11119027});n.rotateY(Math.PI),n.position.set(e.mirrorCenter.x+t*sd,e.mirrorCenter.y,e.mirrorCenter.z),this.scene.add(n),this.reflectors.push(n)}}cLow(){let e=0;for(let t=9;t>=0;t--)e=e*25+this.c0[t];return e}retile(){let e=this.template,t=new q,n=new q,r=new q().makeScale(1e-6,1e-6,1e-6),i=this.cLow(),a=0,o=0,s=new J;for(let o of this.dys)for(let c of this.dxs){t.makeTranslation(c*sd,o*rd,0);for(let e of this.shells)e.setMatrixAt(a,t);if(this.quality.liveMirrors&&o===0&&(c===0||c===-1)?this.glass.setMatrixAt(a,r):this.glass.setMatrixAt(a,n.makeTranslation(c*sd+e.mirrorCenter.x,o*rd+e.mirrorCenter.y,e.mirrorCenter.z)),Math.abs(o)>this.quality.bookFloors){let e=new q().makeScale(1e-6,1e-6,1e-6);for(let t=0;t<640;t++)this.books.setMatrixAt(a*640+t,e)}else{let t=Tu.fromString(`tints`,i+c,this.f0+o),n=new q;for(let r=0;r<640;r++){n.copy(e.bookMatrices[r]),n.elements[12]+=c*sd,n.elements[13]+=o*rd,this.books.setMatrixAt(a*640+r,n),s.copy(rf[t.int(rf.length)]);let i=.82+t.float()*.36;s.multiplyScalar(i),this.books.setColorAt(a*640+r,s)}}a++}let c=(this.dys[this.dys.length-1]+1)*rd+_f/2,l=this.dys[0]*rd-nd-_f/2;for(let n of this.dxs)for(let r of[c,l])t.makeTranslation(n*sd,r,0),this.tubes.setMatrixAt(o,t),t.makeTranslation(n*sd+e.stairAxis.x,r,e.stairAxis.z),this.stairTubes.setMatrixAt(o,t),o++;for(let e of this.shells)e.instanceMatrix.needsUpdate=!0;this.books.instanceMatrix.needsUpdate=!0,this.books.instanceColor&&(this.books.instanceColor.needsUpdate=!0),this.glass.instanceMatrix.needsUpdate=!0,this.tubes.instanceMatrix.needsUpdate=!0,this.stairTubes.instanceMatrix.needsUpdate=!0;let u=this.template.lampCenters;for(let e=0;e<6;e++){let t=[-1,-1,0,0,1,1][e],n=u[e%2];this.lights[e].position.set(t*sd+n.x,n.y-.05,n.z)}this.lights[6].position.set(sd/2-.4,1.7,0),this.lights[7].position.set(-sd/2+.4,1.7,0),this.lights[8].position.set(e.stairAxis.x,1.1,e.stairAxis.z),this.lights[9].position.set(0,rd+u[0].y,0),this.lights[10].position.set(0,-rd+u[0].y,0)}shiftX(e){return pu(this.c0,e),this.retile(),-e*sd}shiftY(e,t){return this.f0+=e,t?.skipRetile||this.retile(),-e*rd}coordAt(e,t){let n=du(this.c0);return pu(n,e),{c:n,f:this.f0+t}}resolveBookInstance(e){let t=Math.floor(e/640),n=e%640;return{dx:this.dxs[t%this.dxs.length],dy:this.dys[Math.floor(t/this.dxs.length)],wall:Math.floor(n/160),shelf:Math.floor(n/32)%5,volume:n%32}}bookInstanceId(e,t,n,r,i){let a=this.dxs.indexOf(e),o=this.dys.indexOf(t);return a<0||o<0?-1:(o*this.dxs.length+a)*640+(n*5+r)*32+i}bookWorldPos(e,t,n,r,i){let a=(n*5+r)*32+i,o=new W;return o.setFromMatrixPosition(this.template.bookMatrices[a]),o.x+=e*sd,o.y+=t*rd,o}get booksMesh(){return this.books}setBookHidden(e,t){let n=new q;this.books.getMatrixAt(e,n);let r=t?1e-6:1,i=this.resolveBookInstance(e),a=this.template.bookMatrices[(i.wall*5+i.shelf)*32+i.volume].clone();a.elements[12]+=i.dx*sd,a.elements[13]+=i.dy*rd,t&&a.scale(new W(r,r,r)),this.books.setMatrixAt(e,a),this.books.instanceMatrix.needsUpdate=!0}setHighlight(e,t=0){if(this.highlightMesh&&=(this.scene.remove(this.highlightMesh),null),!e)return;let n=new Ar(new ni(gd+.025,md+.03,hd+.03),this.palette.glow);n.position.copy(e),n.rotation.y=t,this.scene.add(n),this.highlightMesh=n}pulse(e){this.highlightMesh&&(this.palette.glow.opacity=.25+.2*Math.sin(e*5))}setMeshVisible(e,t){let n={wood:this.shells[0],stone:this.shells[1],brass:this.shells[2],lamps:this.shells[3],books:this.books,glass:this.glass,tubes:this.tubes,stairTubes:this.stairTubes}[e];return n?(n.visible=t,!0):!1}debugInfo(){let e=(e,t)=>{let n=new q,r=[];for(let t of[0,this.dxs.length+3,this.dxs.length*2+3,e.count-1])t>=e.count||(e.getMatrixAt(t,n),r.push({u:t,x:+n.elements[12].toFixed(2),y:+n.elements[13].toFixed(2),sx:+n.elements[0].toFixed(4)}));return{name:t,count:e.count,visible:e.visible,rows:r}};return{dxs:this.dxs,dys:this.dys,shells:this.shells.map((t,n)=>e(t,`shell${n}`)),tubes:e(this.tubes,`tubes`),books:e(this.books,`books`)}}*segmentsNear(e){let t=Math.round(e/sd);for(let e=-1;e<=1;e++){let n=(t+e)*sd;for(let e of this.template.segments)yield{...e,ax:e.ax+n,bx:e.bx+n}}}stairAxesNear(e){let t=Math.round(e/sd),n=[];for(let e=-1;e<=1;e++)n.push({x:this.template.stairAxis.x+(t+e)*sd,z:this.template.stairAxis.z});return n}},yf=[`southeast`,`southwest`,`northwest`,`northeast`];function bf(e){return yf[e]??`wall ${e}`}var xf=class{cb;root;hudName;hudFloor;hudSteps;prompt;toastEl;toastTimer=0;bookView;bookSpine;bookWhere;bookPageText;pageSlider;pageNum;pageLabel;openBookRef=null;currentPage=0;highlight=null;seekPanel;seekText;seekPreview;seekNotes;seekResultEl;seekErrorEl;copyIndex=0;lastSeek=null;startOverlay;helpOverlay;fallOverlay;fadeEl;constructor(e,t){this.cb=t,this.root=e,this.build()}build(){this.root.insertAdjacentHTML(`beforeend`,`
      <div id="vignette"></div>
      ...
      <div id="fade"></div>
      `),this.hudName=document.getElementById(`hudName`),this.hudFloor=document.getElementById(`hudFloor`),this.hudSteps=document.getElementById(`hudSteps`),this.prompt=document.getElementById(`prompt`),this.toastEl=document.getElementById(`toast`),this.fadeEl=document.getElementById(`fade`),this.buildBookView(),this.buildSeekPanel(),this.buildOverlays()}buildBookView(){this.root.insertAdjacentHTML(`beforeend`,`
      <div id="bookView" class="hidden">
        <div class="volume">
          ...
          <footer>
            ...
            <input id="pageSlider" type="range" min="1" max="410" value="1" />
            <button id="pageNext">next</button>
            <span>page <input id="pageNum" type="number" min="1" max="410" value="1" /> of 410</span>
      ...
      `),this.bookView=document.getElementById(`bookView`),this.bookSpine=document.getElementById(`bookSpine`),this.bookWhere=document.getElementById(`bookWhere`),this.bookPageText=document.getElementById(`pageText`),this.pageSlider=document.getElementById(`pageSlider`),this.pageNum=document.getElementById(`pageNum`),this.pageLabel=document.getElementById(`pageLabel`),document.getElementById(`bookClose`).addEventListener(`click`,()=>this.cb.onCloseBook()),document.getElementById(`pagePrev`).addEventListener(`click`,()=>this.showPage(this.currentPage-1)),document.getElementById(`pageNext`).addEventListener(`click`,()=>this.showPage(this.currentPage+1)),this.pageSlider.addEventListener(`input`,()=>this.showPage(parseInt(this.pageSlider.value,10)-1)),this.pageNum.addEventListener(`change`,()=>this.showPage(parseInt(this.pageNum.value,10)-1)),document.getElementById(`copyPage`).addEventListener(`click`,()=>{this.openBookRef&&(navigator.clipboard?.writeText(Ju(this.openBookRef,this.currentPage)).catch(()=>{}),this.toast(`page copied`))}),document.getElementById(`copyAddr`).addEventListener(`click`,()=>{if(!this.openBookRef)return;let e=this.openBookRef,t=`hexagon ${e.hexName}, floor ${e.location.coord.f}, ${bf(e.location.wall)} wall, shelf ${e.location.shelf+1}, volume ${e.location.volume+1}, page ${this.currentPage+1}`;navigator.clipboard?.writeText(t).catch(()=>{}),this.toast(`address copied: `+t)})}buildSeekPanel(){this.root.insertAdjacentHTML(`beforeend`,`
      ...
      `),this.seekPanel=document.getElementById(`seekPanel`),this.seekText=document.getElementById(`seekText`),this.seekPreview=document.getElementById(`seekPreview`),this.seekNotes=document.getElementById(`seekNotes`),this.seekResultEl=document.getElementById(`seekResult`),this.seekErrorEl=document.getElementById(`seekError`),this.seekText.addEventListener(`input`,()=>{this.copyIndex=0,this.updatePreview()}),document.getElementById(`seekGo`).addEventListener(`click`,()=>this.runSeek()),document.getElementById(`seekAnother`).addEventListener(`click`,()=>{this.copyIndex++,this.runSeek()}),document.getElementById(`seekShare`).addEventListener(`click`,()=>{let e=this.cb.onShare();e&&(navigator.clipboard?.writeText(e).catch(()=>{}),this.toast(`link copied — it leads to this very book`))})}buildOverlays(){this.root.insertAdjacentHTML(`beforeend`,`
      ...
      `),this.startOverlay=document.getElementById(`startOverlay`),this.helpOverlay=document.getElementById(`helpOverlay`),this.fallOverlay=document.getElementById(`fallOverlay`),document.getElementById(`helpClose`).addEventListener(`click`,()=>{this.helpOverlay.classList.add(`hidden`),this.cb.onResume()}),document.getElementById(`wakeBtn`).addEventListener(`click`,()=>this.cb.onWake())}bindStart(e){document.getElementById(`enterBtn`).addEventListener(`click`,()=>{let t=document.getElementById(`qualityLow`).checked;this.startOverlay.classList.add(`hidden`),e(t)})}startHidden(){return this.startOverlay.classList.contains(`hidden`)}setHud(e,t,n,r){this.hudName.textContent=e,this.hudFloor.textContent=`floor ${t.toLocaleString(`en-US`)}`,this.hudSteps.textContent=r?`unfathomably far from your first hexagon`:n===0?`the hexagon of your first waking`:`${Math.abs(n).toLocaleString(`en-US`)} ${n>0?`east`:`west`} of your first hexagon`}setPrompt(e){e===null?this.prompt.classList.add(`hidden`):(this.prompt.innerHTML=e,this.prompt.classList.remove(`hidden`))}toast(e,t=2600){this.toastEl.textContent=e,this.toastEl.style.opacity=`1`,window.clearTimeout(this.toastTimer),this.toastTimer=window.setTimeout(()=>{this.toastEl.style.opacity=`0`},t)}fade(e){this.fadeEl.classList.toggle(`dark`,e)}openBook(e,t){this.openBookRef=e,this.highlight=t?.highlight??null,this.bookSpine.textContent=e.spine;let n=e.location;this.bookWhere.textContent=`hexagon ${e.hexName} · floor ${n.coord.f.toLocaleString(`en-US`)} · ${bf(n.wall)} wall · shelf ${n.shelf+1} of 5 · volume ${n.volume+1} of 32`,this.bookView.classList.remove(`hidden`),this.showPage(t?.page??0)}closeBook(){this.bookView.classList.add(`hidden`),this.openBookRef=null,this.highlight=null}bookIsOpen(){return!this.bookView.classList.contains(`hidden`)}showPage(e){if(!this.openBookRef)return;e=Math.max(0,Math.min(409,e)),this.currentPage=e;let t=Ju(this.openBookRef,e);if(this.highlight&&this.highlight.page===e){let n=this.highlight.start-e*$l,r=Math.max(0,n),i=Math.min($l,n+this.highlight.length);this.bookPageText.innerHTML=wf(Sf(t.slice(0,r)))+`<mark>`+wf(Sf(t.slice(r,i)),r)+`</mark>`+wf(Sf(t.slice(i)),i)}else this.bookPageText.textContent=Cf(t);this.pageSlider.value=String(e+1),this.pageNum.value=String(e+1);let n=this.highlight;this.pageLabel.textContent=n?n.page===e?`— the sought page`:`— sought text on page ${n.page+1}`:``}get openedBook(){return this.openBookRef}get shownPage(){return this.currentPage}toggleSeek(e){let t=e??this.seekPanel.classList.contains(`hidden`);return this.seekPanel.classList.toggle(`hidden`,!t),t&&(this.updatePreview(),setTimeout(()=>this.seekText.focus(),30)),t}seekIsOpen(){return!this.seekPanel.classList.contains(`hidden`)}setSeekText(e,t){this.seekText.value=e;let n=document.querySelector(`input[name=seekMode][value=${t}]`);n&&(n.checked=!0),this.updatePreview()}updatePreview(){let e=this.seekText.value;if(!e){this.seekPreview.classList.add(`hidden`),this.seekNotes.textContent=``;return}let t=au(e);this.seekPreview.classList.remove(`hidden`),this.seekPreview.textContent=t.text.length?t.text:`(nothing survives)`;let n=[];t.substituted.length&&n.push(`the librarians transcribe: `+t.substituted.join(`, `)),t.dropped.length&&n.push(`no symbol exists for: `+t.dropped.join(` `)),n.push(`${t.text.length.toLocaleString(`en-US`)} characters`),this.seekNotes.textContent=n.join(` · `)}runSeek(){let e=document.querySelector(`input[name=seekMode]:checked`)?.value??`context`,t=this.cb.onSeek(this.seekText.value,e,this.copyIndex);if(typeof t==`string`){this.seekErrorEl.textContent=t,this.seekErrorEl.classList.remove(`hidden`),this.seekResultEl.classList.add(`hidden`),document.getElementById(`seekAnother`).classList.add(`hidden`),document.getElementById(`seekShare`).classList.add(`hidden`),this.lastSeek=null;return}this.lastSeek=t,this.seekErrorEl.classList.add(`hidden`),this.showSeekResult(t)}showSeekResult(e){this.seekResultEl.classList.remove(`hidden`),document.getElementById(`seekAnother`).classList.remove(`hidden`),document.getElementById(`seekShare`).classList.remove(`hidden`),this.seekResultEl.innerHTML=`It stands where it has always stood:<br/><span class="addr" id="seekAddr"></span><br/>floor <span id="seekFloor"></span> · ${bf(e.location.wall)} wall · shelf ${e.location.shelf+1} · volume ${e.location.volume+1} · page ${e.page+1}${e.copy>0?`<br/>(copy ${e.copy+1} — other volumes hold these words too)`:``}<div class="row"><button id="travelBtn">Travel there</button></div>`,document.getElementById(`seekFloor`).textContent=e.location.coord.f.toLocaleString(`en-US`),document.getElementById(`travelBtn`).addEventListener(`click`,()=>this.cb.onTravel())}setSeekAddr(e){let t=document.getElementById(`seekAddr`);t&&(t.textContent=`hexagon ${e}`)}showHelp(e){this.helpOverlay.classList.toggle(`hidden`,!e)}helpIsOpen(){return!this.helpOverlay.classList.contains(`hidden`)}showFall(e){this.fallOverlay.classList.toggle(`hidden`,!e)}setMuteLabel(e){document.getElementById(`btnMute`).textContent=e?`Sound: off`:`Sound: on`}bindButtons(e){document.getElementById(`btnSeek`).addEventListener(`click`,e.seek),document.getElementById(`btnHelp`).addEventListener(`click`,e.help),document.getElementById(`btnMute`).addEventListener(`click`,e.mute)}};function Sf(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function Cf(e){let t=[];for(let n=0;n<40;n++)t.push(e.slice(n*80,(n+1)*80));return t.join(`
`)}function wf(e,t=0){let n=``,r=t%80;for(let t of e)n+=t,r++,r===80&&(n+=`
`,r=0);return n}var Tf=class{ctx=null;master=null;muted=!1;start(){if(!this.ctx)try{let e=new(window.AudioContext||window.webkitAudioContext);this.ctx=e,this.master=e.createGain(),this.master.gain.value=.55,this.master.connect(e.destination);let t=e.sampleRate*4,n=e.createBuffer(1,t,e.sampleRate),r=n.getChannelData(0),i=0;for(let e=0;e<t;e++){let t=Math.random()*2-1;i=(i+.02*t)/1.02,r[e]=i*3.2}let a=e.createBufferSource();a.buffer=n,a.loop=!0;let o=e.createBiquadFilter();o.type=`lowpass`,o.frequency.value=240;let s=e.createGain();s.gain.value=.05,a.connect(o).connect(s).connect(this.master),a.start();let c=e.createOscillator();c.frequency.value=.05;let l=e.createGain();l.gain.value=.018,c.connect(l).connect(s.gain),c.start()}catch{this.ctx=null}}toggleMute(){return this.muted=!this.muted,this.master&&(this.master.gain.value=this.muted?0:.55),this.muted}isMuted(){return this.muted}burst(e,t,n,r,i=`bandpass`){if(!this.ctx||!this.master||this.muted)return;let a=this.ctx,o=Math.ceil(a.sampleRate*n),s=a.createBuffer(1,o,a.sampleRate),c=s.getChannelData(0);for(let e=0;e<o;e++)c[e]=(Math.random()*2-1)*(1-e/o)**2.2;let l=a.createBufferSource();l.buffer=s;let u=a.createBiquadFilter();u.type=i,u.frequency.value=e,u.Q.value=t;let d=a.createGain();d.gain.value=r,l.connect(u).connect(d).connect(this.master),l.start()}footstep(){this.burst(620+Math.random()*240,1.1,.09,.16)}bookSlide(){this.burst(1700,.7,.16,.1,`highpass`)}pageFlutter(){this.burst(2600,.5,.07,.06,`highpass`)}thud(){this.burst(140,1.4,.18,.3,`lowpass`)}whoosh(){if(!this.ctx||!this.master||this.muted)return;let e=this.ctx,t=1.6,n=Math.ceil(e.sampleRate*t),r=e.createBuffer(1,n,e.sampleRate),i=r.getChannelData(0);for(let e=0;e<n;e++){let t=e/n;i[e]=(Math.random()*2-1)*Math.sin(Math.PI*t)**1.5}let a=e.createBufferSource();a.buffer=r;let o=e.createBiquadFilter();o.type=`bandpass`,o.Q.value=2.2,o.frequency.setValueAtTime(220,e.currentTime),o.frequency.exponentialRampToValueAtTime(2400,e.currentTime+t*.7),o.frequency.exponentialRampToValueAtTime(160,e.currentTime+t);let s=e.createGain();s.gain.value=.34,a.connect(o).connect(s).connect(this.master),a.start();let c=e.createOscillator();c.frequency.value=196;let l=e.createGain();l.gain.setValueAtTime(1e-4,e.currentTime+t*.8),l.gain.exponentialRampToValueAtTime(.12,e.currentTime+t*.85),l.gain.exponentialRampToValueAtTime(1e-4,e.currentTime+t+1.4),c.connect(l).connect(this.master),c.start(e.currentTime+t*.8),c.stop(e.currentTime+t+1.5)}wind(e){!this.ctx||!this.master||(this.master.gain.cancelScheduledValues(this.ctx.currentTime),this.master.gain.linearRampToValueAtTime(e?1.1:this.muted?0:.55,this.ctx.currentTime+.8))}},Ef=new URLSearchParams(location.search),Df=Ef.get(`test`)===`1`,Z=new xf(document.getElementById(`app`),{onSeek:ip,onTravel:ap,onCloseBook:rp,onResume:Jf,onWake:cp,onShare:sp}),Of=new Ql({antialias:!Df,powerPreference:`high-performance`,preserveDrawingBuffer:Df});Of.toneMapping=4,Of.toneMappingExposure=1.15,document.getElementById(`scene`).appendChild(Of.domElement);var kf=!1;Of.domElement.addEventListener(`webglcontextlost`,()=>{kf=!0});var Q=null,$=null,Af=new Tf,jf=0,Mf=!1,Nf=!1,Pf=null,Ff=null,If=null,Lf=-1;function Rf(e){let t=Ef.get(`quality`),n=t===`high`?hf:t===`low`||e||Df?gf:hf;if(Q=new vf(Au(),n),$=new Jd(Q,{onShiftX:e=>{Q.shiftX(e),jf+=e,Xf(),op()},onShiftY:e=>{Q.shiftY(e,{skipRetile:$.mode===`falling`}),Xf(),op()},onStartFalling:()=>{Af.wind(!0),window.setTimeout(()=>{$.mode===`falling`&&(document.exitPointerLock?.(),Z.showFall(!0))},4200)},onStep:()=>Af.footstep()},window.innerWidth/window.innerHeight),Of.setPixelRatio(Math.min(window.devicePixelRatio,n.dpr)),Of.setSize(window.innerWidth,window.innerHeight),$.pos.set(0,0,-1.15),$.yaw=-Math.PI/2,$.enabled=!0,Af.start(),Z.setMuteLabel(!1),Xf(),qf(),Ef.get(`seek`)){let e=Ef.get(`seek`),t=Ef.get(`mode`)===`alone`?`alone`:`context`,n=parseInt(Ef.get(`copy`)??`0`,10)||0;Z.toggleSeek(!0),Z.setSeekText(e,t);let r=ip(e,t,n);typeof r!=`string`&&(Z.showSeekResult(r),Z.setSeekAddr(Mu(Ou(r.location.coord))),window.setTimeout(()=>ap(),600))}}Z.bindStart(Rf),Z.bindButtons({seek:()=>Yf(),help:()=>{Z.showHelp(!Z.helpIsOpen()),$&&($.enabled=!Z.helpIsOpen())},mute:()=>{Nf=Af.toggleMute(),Z.setMuteLabel(Nf)}});var zf=new Po,Bf=0,Vf=0,Hf=0,Uf={update:0,aim:0,render:0,gap:0,raf:0},Wf=0;function Gf(e,t=!1){Df||requestAnimationFrame(()=>Gf());let n=performance.now();Uf.gap=n-Wf,Wf=n,Uf.raf++;let r=e??Math.min(zf.getDelta(),.05);if(!Q||!$)return;let i=Z.bookIsOpen()||Z.helpIsOpen()||!Z.startHidden();$.enabled=!i&&$.mode!==`falling`&&!Kf();let a=performance.now();$.update(r),Uf.update=performance.now()-a,Q.pulse(n/1e3),a=performance.now(),ep(),Uf.aim=performance.now()-a,t?Q.scene.updateMatrixWorld():(a=performance.now(),Of.render(Q.scene,$.camera),Uf.render=performance.now()-a),Bf++,Vf+=r,Vf>=1&&(Hf=Bf/Vf,Bf=0,Vf=0)}Df||Gf();function Kf(){return document.activeElement instanceof HTMLTextAreaElement||document.activeElement instanceof HTMLInputElement}function qf(){Of.domElement.requestPointerLock?.()}function Jf(){$&&($.enabled=!0),qf()}Of.domElement.addEventListener(`click`,()=>{!Z.startHidden()||!$||Z.bookIsOpen()||qf()}),document.addEventListener(`mousemove`,e=>{document.pointerLockElement===Of.domElement&&$&&$.mouseLook(e.movementX,e.movementY)}),document.addEventListener(`keydown`,e=>{if($&&e.code!==`Escape`&&!Kf()){switch(e.code){case`KeyE`:Z.bookIsOpen()?rp():tp(),e.preventDefault();return;case`KeyF`:Yf(),e.preventDefault();return;case`KeyH`:Z.showHelp(!Z.helpIsOpen());return;case`KeyM`:Nf=Af.toggleMute(),Z.setMuteLabel(Nf);return}if(Z.bookIsOpen()){(e.code===`ArrowRight`||e.code===`PageDown`)&&Z.showPage(Z.shownPage+1),(e.code===`ArrowLeft`||e.code===`PageUp`)&&Z.showPage(Z.shownPage-1);return}$.keyDown(e.code)}}),document.addEventListener(`keyup`,e=>$?.keyUp(e.code)),window.addEventListener(`blur`,()=>$?.clearKeys()),window.addEventListener(`resize`,()=>{Of.setSize(window.innerWidth,window.innerHeight),$&&($.camera.aspect=window.innerWidth/window.innerHeight,$.camera.updateProjectionMatrix())});function Yf(){Z.toggleSeek()?document.exitPointerLock?.():$&&($.enabled=!0)}function Xf(){if(!Q)return;let e=Ou({c:Q.c0,f:Q.f0});Z.setHud(Mu(e),Q.f0,jf,Mf)}var Zf=new jo;Zf.far=2.1;var Qf=new U(0,0),$f=null;function ep(){if(!Q||!$||Z.bookIsOpen()||$.mode===`falling`){if(Z.bookIsOpen())return;$f=null,Z.setPrompt(null);return}$.camera.updateMatrixWorld(),Zf.setFromCamera(Qf,$.camera);let e=Zf.intersectObject(Q.booksMesh,!1);if(e.length===0||e[0].instanceId===void 0){$f&&($f=null,Z.setPrompt(null));return}let t=e[0].instanceId;if($f?.instanceId===t)return;let n=Q.resolveBookInstance(t);if(n.dy!==0){$f=null,Z.setPrompt(null);return}$f={instanceId:t,...n};let r=Yu(Q.coordAt(n.dx,n.dy),n.wall,n.shelf,n.volume);Z.setPrompt(`<span class="spine">${r}</span> &nbsp;·&nbsp; press <b>E</b> to take this volume`)}function tp(){if(!Q||!$||!$f)return;let e=$f;np({coord:Q.coordAt(e.dx,e.dy),wall:e.wall,shelf:e.shelf,volume:e.volume},e.instanceId)}function np(e,t,n){if(!Q||!$)return;Af.bookSlide(),$.clearKeys();let r=qu(e),i=n;if(!i&&Ff){let t=Ff.location;t.wall===e.wall&&t.shelf===e.shelf&&t.volume===e.volume&&t.coord.f===e.coord.f&&fu(t.coord.c,e.coord.c)&&(i={page:Ff.page,highlight:{page:Ff.page,start:Ff.offset,length:Ff.length}},Q.setHighlight(null),If=null)}t>=0&&(Q.setBookHidden(t,!0),Lf=t),document.exitPointerLock?.(),Z.openBook(r,i)}function rp(){Q&&(Af.pageFlutter(),Z.closeBook(),Lf>=0&&(Q.setBookHidden(Lf,!1),Lf=-1),Jf())}function ip(e,t,n){try{let r=Zu(e,t,n);return Pf=r,window.setTimeout(()=>Z.setSeekAddr(Mu(Ou(r.location.coord))),0),r}catch(e){if(e instanceof Xu)return e.message;throw e}}function ap(){if(!Pf||!Q||!$)return;let e=Pf;Af.whoosh(),Z.fade(!0),Z.toggleSeek(!1),window.setTimeout(()=>{if(!Q||!$)return;Q.c0=du(e.location.coord.c),Q.f0=e.location.coord.f,Q.retile(),Mf=!0,jf=0,Ff=e,If={dx:0,dy:0,wall:e.location.wall,shelf:e.location.shelf,volume:e.location.volume},op();let t=Q.bookWorldPos(0,0,e.location.wall,e.location.shelf,e.location.volume),n=Math.hypot(t.x,t.z)||1;$.pos.set(t.x/n*.98,0,t.z/n*.98),$.land();let r=t.x-$.pos.x,i=t.z-$.pos.z;$.yaw=Math.atan2(-i,r),$.pitch=Math.atan2(t.y-Fd,Math.hypot(r,i)),Xf(),Z.fade(!1),Z.toast(`You wake in hexagon ${Mu(Ou(e.location.coord))}. The volume waits on the ${bf(e.location.wall)} wall, shelf ${e.location.shelf+1}, place ${e.location.volume+1} — it glows for you.`,6500),window.setTimeout(()=>Jf(),80)},700)}function op(){if(!Q)return;if(!If||!Ff){Q.setHighlight(null);return}let e=If,t=Ff.location.coord,n=null;if(Q.f0===t.f){for(let e=-Q.quality.rx;e<=Q.quality.rx;e++)if(fu(Q.coordAt(e,0).c,t.c)){n=e;break}}if(n===null){Q.setHighlight(null);return}let r=Q.bookWorldPos(n,0,e.wall,e.shelf,e.volume);Q.setHighlight(r,Q.template.wallYaws[e.wall])}function sp(){if(!Pf)return null;let e=new URL(location.href.split(`?`)[0]);return e.searchParams.set(`seek`,Pf.transliteration.text),e.searchParams.set(`mode`,Pf.mode),Pf.copy&&e.searchParams.set(`copy`,String(Pf.copy)),e.toString()}function cp(){!Q||!$||(Z.showFall(!1),Z.fade(!0),Af.wind(!1),window.setTimeout(()=>{!Q||!$||(Q.f0-=8191,Q.retile(),$.pos.set(0,0,-(ld+.55)),$.land(),$.yaw=-Math.PI/2,$.pitch=0,Mf=!0,Xf(),Z.fade(!1),Af.thud(),Z.toast(`You wake on a remote floor. The fall continues without you.`,5e3))},750))}Df&&(window.__babel={frame:(e=1,t=16.7)=>{for(let n=0;n<e;n++)Gf(t/1e3,!0);return Uf.raf},draw:()=>(Gf(.001,!1),!0),state:()=>({started:Z.startHidden(),hexName:Q?Mu(Ou({c:Q.c0,f:Q.f0})):null,floor:Q?.f0??null,steps:jf,pos:$?{x:$.pos.x,y:$.pos.y,z:$.pos.z}:null,yaw:$?.yaw??0,pitch:$?.pitch??0,mode:$?.mode??`none`,grounded:$?.grounded??!1,bookOpen:Z.bookIsOpen(),seekOpen:Z.seekIsOpen(),aimed:$f?{wall:$f.wall,shelf:$f.shelf,volume:$f.volume,dx:$f.dx}:null,fps:Hf,perf:{...Uf},render:{calls:Of.info.render.calls,triangles:Of.info.render.triangles},contextLost:kf}),openedBook:()=>{let e=Z.openedBook;return e?{spine:e.spine,hexName:e.hexName,wall:e.location.wall,shelf:e.location.shelf,volume:e.location.volume,floor:e.location.coord.f,page:Z.shownPage,pageTextLength:$l}:null},pageText:()=>Z.openedBook?document.getElementById(`pageText`)?.textContent??``:``,markText:()=>document.querySelector(`#pageText mark`)?.textContent??null,setView:(e,t)=>{$&&($.yaw=e,$.pitch=t)},aimAtBook:(e,t,n)=>{if(!Q||!$)return!1;let r=Q.bookWorldPos(0,0,e,t,n),i=Q.template.wallYaws[e];r.x-=Math.sin(i)*(hd/2-.005),r.z-=Math.cos(i)*(hd/2-.005);let a=new W($.pos.x,$.pos.y+Fd,$.pos.z),o=r.clone().sub(a);return $.yaw=Math.atan2(-o.z,o.x),$.pitch=Math.atan2(o.y,Math.hypot(o.x,o.z)),!0},seekResult:()=>Pf?{hexName:Mu(Ou(Pf.location.coord)),floor:Pf.location.coord.f,wall:Pf.location.wall,shelf:Pf.location.shelf,volume:Pf.location.volume,page:Pf.page,offset:Pf.offset,text:Pf.transliteration.text}:null,pressE:()=>{Z.bookIsOpen()?rp():tp()},worldInfo:()=>Q?.debugInfo()??null,teleport:(e,t,n)=>{$?.pos.set(e,t,n),$?.land()},setMeshVisible:(e,t)=>Q?.setMeshVisible(e,t)??!1,canvasStats:()=>{let e=Of.domElement,t=document.createElement(`canvas`);t.width=160,t.height=120;let n=t.getContext(`2d`);n.drawImage(e,0,0,160,120);let r=n.getImageData(0,0,160,120).data,i=0,a=0,o=new Set;for(let e=0;e<r.length;e+=4){let t=r[e]+r[e+1]+r[e+2];i+=t,t>a&&(a=t),o.add(r[e]>>4|r[e+1]>>4<<4|r[e+2]>>4<<8)}return{mean:i/(r.length/4)/3,max:a/3,distinct:o.size}}});