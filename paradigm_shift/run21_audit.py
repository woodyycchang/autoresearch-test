...
Reads : run_021/logs/{atoms_reasoning,atom_search,candidates,verify,verify_reasoning,crosscheck}.json
Writes: run_021/logs/reasoning_audit.json
"""
...
def main():
    ...
    out = {"run_id": "run_021", "agent": "5_reasoning_auditor",
           "audited_at": datetime.now(timezone.utc).isoformat(),
           "method": "deterministic rule-based audit over committed reasoning_traces; rules in "
                     "run21_rules; auditor emits its own reasoning_trace per audited trace (not a black box).",
