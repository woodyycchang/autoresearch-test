...
def main():
    ...
    print(json.dumps({
        "n_generated": len(cons), "n_genuine": len(genuine), "n_approaches": len(KNOWN_APPROACHES),
        "verdict_counts": dict(counts), "reason_counts": dict(reasons),
        "borderline": borderline, "digest": digest}))
